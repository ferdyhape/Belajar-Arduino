...
int i = 0;
const char* text[3] = {"Hello", "Ferdy", "Here!"};
 
void loop() {
  if (myDisplay.displayAnimate()) {
    if (i < sizeof(text)) {
      myDisplay.displayText(text[i], myDisplay.getTextAlignment(), myDisplay.getSpeed(), myDisplay.getPause(), PA_SCROLL_DOWN, PA_SCROLL_UP);
      i++;
    }
